...
class TodCommandGroup(app_commands.Group):
    ...
    @app_commands.command(name="reset", description="Deletes the current timer for a specific boss.")
    @app_commands.describe(boss="The boss whose timer you want to reset.")
    @app_commands.choices(boss=[
        app_commands.Choice(name="Ant Queen", value="AQ"),
        app_commands.Choice(name="Baium", value="BAIUM")
    ])
